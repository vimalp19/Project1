jQuery(function($) {
    ...
    //var questionOptions = $('<br> <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4 btn-group-vertical" id="questionOptions"> <button type="button" class="btn btn-success" id="new">Create New Question</button> <button type="button" class="btn btn-success" id="pre">Pre-reading Question</button> <button type="button" class="btn btn-success" id="during">During reading Question</button> <button type="button" class="btn btn-success" id="post">Post-reading Question</button> </div> <br> <br> <br>');
    var newQuestionButton;
    var prereadingButton = $('<div class="form-group"><label class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5" for="prereading"> <input class="btn btn-success btn-lg" type="button" name="prereading" id="prereading" value="Pre-reading Question"> </label> </div>');
    var duringreadingButton;
    var postreadingButton;
